...
//$mail->addAttachment('/tmp/image.jpg', 'new.jpg');    //Optional name
            ...
            if($resultat){
                echo"<h4 class='alert-warning p-2'>Cet email n'est pas disponible</h4>";
        ...
        <?php
                ...
                $sql = "INSERT INTO utilisateurs(emailUtiisateur, passwordUtilisateur, role) VALUES (?,?,?)");


                $request = $mail->prepare($sql);

                //Lie les 3 champs du formulaire a la requète SQL

                $request ->bindParam(1, $this->emailUtilisateur);
                $request ->bindParam(2, $this->passwordUtilisteur);
