<div class="container text-center " id="editArticle">
    <!--créer le formulaire et utiliser l"ID pour le traitement-->

    <form  method="post" id="form-update"  enctype="multipart/form-data">
        <h2 class="text-center  m-5">MAITRE A JOUR LE MENU</h2>
        ...
        <div class="container text-center mt-5">
            <div class="btn-group " role="group" aria-label="Basic example">
                <button name="btn_editer_menu" class="a-anime m-2 ">Maitre à jour</button>
